...
public class KangOSSpecUtils {
    private static final String DEVICE_NAME_MODEL_PROPERTY = "ro.product.system.model";
    private static final String MAINTAINER_NAME_MODEL_PROPERTY = "ro.kangos.maintainer";
    private static final String KANGOS_CPU_MODEL_PROPERTY = "ro.kangos.cpu";
    private static final String FALLBACK_CPU_MODEL_PROPERTY = "ro.board.model";
    private static final String KANGOS_MAINTAINER_PROPERTY = "ro.kangos.maintainer";
    ...
    public static String getProcessorModel() {
        String cpuModelKangOS = SystemProperties.get(KANGOS_CPU_MODEL_PROPERTY);
        String cpuModelFallback = SystemProperties.get(FALLBACK_CPU_MODEL_PROPERTY);
        if (!cpuModelKangOS.isEmpty()) {
            return cpuModelKangOS;
