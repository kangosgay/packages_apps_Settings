...
public class RomCardView extends AboutBaseCard {
    ...
    public void init(Context context) {
        ...
        rom_logo.setPadding(42, 42, 42, 42);
        ...
        String title = getResources().getString(R.string.about_device_rom_title);
        String version = SystemProperties.get("ro.kangos.version");
        String releaseType = SystemProperties.get("ro.kangos.build.type");
        TextView rom_title = new TextView(context);
        rom_title.setText(String.format("%1$s  %2$s", title, version));
        ...
        rom_version.setPadding(0, 4, 0, 12);
        rom_version.setTextSize(16);
